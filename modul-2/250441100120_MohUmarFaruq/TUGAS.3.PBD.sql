...
UPDATE pasien SET no_telepon = '0899999' WHERE id_pasien = 101;
SELECT *FROM pasien

UPDATE dokter SET spesialisasi = 'Spesialis Mata' WHERE id_dokter = 4;
SELECT *FROM dokter

DELETE FROM rekam_medis WHERE id_rekam = 501;
SELECT *FROM rekam_medis
